...
fun RegisterScreen(
    ...
    Column(
        ...
        Text(
            "Regístrate y luego inicia sesión para sincronizar tus datos.",
            ...
            trailingIcon = {
                IconButton(onClick = { confirmVisible = !confirmVisible }) {
                    Icon(
                        ...
                        contentDescription = if (confirmVisible) "Ocultar contraseña" else "Ver contraseña"
                    )
                }
            },
            modifier = Modifier.fillMaxWidth()
        ...
        Button(
            onClick = { viewModel.register(email, password, confirm, onRegistered) },
